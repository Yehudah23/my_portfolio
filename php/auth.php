...
// Ensure credentials header is present for allowed origins (important for login responses)
$req_origin = $_SERVER['HTTP_ORIGIN'] ?? '';
if (defined('ALLOWED_ORIGINS') && is_array(ALLOWED_ORIGINS) && in_array($req_origin, ALLOWED_ORIGINS)) {
